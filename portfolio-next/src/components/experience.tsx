        ...
        <div className="max-w-3xl">
          <div className="relative pl-8 md:pl-12">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-px">
              <motion.div className="w-full h-full bg-gradient-to-b from-primary/50 via-secondary/30 to-transparent"
            ...
            <div className="absolute left-0 top-0 -translate-x-1/2">
              <motion.div className="w-3.5 h-3.5 rounded-full bg-primary border-[3px] border-bg-base shadow-[0_0_12px_var(--primary)]"
            ...
            <motion.div className="glass-card p-7 md:p-9"
              ...
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-text">Samsung PRISM</h3>
                    <p className="text-primary-light font-medium text-sm">Research Intern</p>
                  </div>
                </div>
                <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-primary/[0.06] text-xs font-semibold text-primary-light border border-primary/10 whitespace-nowrap">
              ...
              <p className="text-text-muted text-sm flex items-center gap-2 mb-4">
                <i className="fa-solid fa-location-dot text-primary text-[10px]" /> Bengaluru, India
              </p>

              <div className="pl-4 border-l-2 border-primary/15 mb-5">
                <p className="text-text-secondary text-sm">
                  <strong className="text-text">Project:</strong> Multilingual Grapheme-to-Phoneme (G2P) Pipeline
                </p>
              </div>
