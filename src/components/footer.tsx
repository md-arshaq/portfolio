...
export default function Footer() {
  return (
    <motion.footer className="relative border-t border-glass-border bg-bg-base/80 backdrop-blur-xl"
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-8 flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <p className="text-text-muted text-[11px] flex items-center gap-1.5">
          Crafted with
          <motion.i className="fa-solid fa-heart text-accent-rose text-[9px]"
            animate={{ scale: [1, 1.25, 1] }} transition={{ duration: 1.5, repeat: Infinity }} />
          using
          <span className="text-primary-light font-medium">Next.js</span>·
          <span className="text-secondary font-medium">Tailwind</span>·
          <span className="text-accent-rose font-medium">Framer Motion</span>
        </p>
      </div>
    </motion.footer>
  );
